  ...
  return (
    <header style={{ backgroundColor: '#000000' }} className="text-white shadow-lg">
      <div className="max-w-5xl mx-auto px-4 py-3">
        ...
        {/* Mobile: logo centered on top, phone + reviews below */}
        {/* Desktop: single row with three columns */}
        <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-0">

          {/* Logo — centered on mobile, center column on desktop */}
          <div className="flex items-center justify-center sm:flex-1 sm:order-2">
            <a
            ...
            >
              <img
                ...
                className="h-16 sm:h-[110px] w-auto"
              />
            </a>
          </div>

          {/* Phone + reviews row on mobile, split to left/right on desktop */}
          <div className="flex items-center justify-between sm:contents">

            {/* Left: phone number */}
            <div className="sm:flex-1 sm:order-1 flex items-center justify-start">
              <a
                href="tel:4045207349"
